<template>
  <el-select ref="select" v-model="valueId" :clearable="clearable" :disabled="disabled" :placeholder="props.placeholder" @clear="clearHandle">
    <el-input v-model="filterText" class="selectInput" :placeholder="placeholder" />
    <el-option :value="valueId" :label="selectedValueTitle" class="options">
      <el-tree
        id="tree-option"
        ref="selectTree"
